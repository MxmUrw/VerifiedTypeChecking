...
module Verification.Experimental.Algebra2.Setoid.Definition where
...
Setoid : (𝑗 : 𝔏 ^ 2) -> 𝒰 _
Setoid 𝑗 = Structure (isSetoid {𝑖 = 𝑗 ⌄ 0} (𝑗 ⌄ 1))
-- 𝒰 (𝑗 ⌄ 0) :& isSetoid (𝑗 ⌄ 1)

record isSetoidHom {A B} {{_ : Setoid 𝑖 on A}} {{_ : Setoid 𝑗 on B}} (f : A -> B) : 𝒰 (𝑖 ､ 𝑗) where
